...
{
    private const string Result = "https://utm-builder.io/" +
                                  "?utm_source=src" +
                                  "&utm_medium=med" +
                                  "&utm_campaign=nme" +
                                  "&utm_id=id" +
    ...
    private readonly Url _url = new("https://utm-builder.io/");
    ...
    {
        Utm utm = Result;
        Assert.AreEqual("https://utm-builder.io/", utm.Url.Address);
